...
def sync_envs_normalization(env: VecEnv):
    if hasattr(env, "normalize_obs") and env.normalize_obs:
        env.obs_rms = env.get_attr("obs_rms")[0]
...
class MultiEnvsEvalCallback(BaseCallback):
    """
