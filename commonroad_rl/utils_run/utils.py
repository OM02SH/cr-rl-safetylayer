...
# from stable_baselines3.common import set_global_seeds, BaseRLModel
...
#     ALGOS["dqn"] = DQN
try:
    from stable_baselines3 import DQN  # 从 SB3 导入 DQN
except ImportError:  # 使用 ImportError 来捕获导入错误
    print("Can't import DQN, skipped!")
else:
    ALGOS["dqn"] = DQN  # 如果导入成功，将 DQN 添加到 ALGOS 字典
...
def load_model_and_vecnormalize(model_path: str, algo: str, normalize: bool, env: gym.Env, model_name="best_model") -> BaseAlgorithm:
    """
