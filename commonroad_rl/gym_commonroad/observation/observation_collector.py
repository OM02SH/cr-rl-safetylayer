...
class ObservationCollector:
    ...
    def observe(self, ego_vehicle: Vehicle) -> Union[np.array, Dict]:
        ...
        observation_dict_surrounding, ego_vehicle_lat_position, detected_obstacles = self.surrounding_observation.observe(self._scenario,
                                                                                                      ego_vehicle,
                                                                                                      self.time_step,
    ...
    def _create_navigator(self) -> Navigator:
        ...
        if not self.navigator:
            ...
            # print("route_candidates: ", route_candidates)
