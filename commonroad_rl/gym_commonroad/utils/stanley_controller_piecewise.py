"""
    Copied from https://github.com/winstxnhdw/FullStanleyController/blob/master/stanley_controller_piecewise.py
"""
...
class StanleyController:
    ...
    def calculate_yaw_term(self, target_index, yaw, pyaw):
        diff = pyaw[target_index] - yaw
        yaw_error = atan2(sin(diff), cos(diff))
